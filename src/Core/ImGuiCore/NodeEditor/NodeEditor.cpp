...
void Core::NodeEditor::ShowNodeEditor()
{
    ImGui::Begin("Node Editor");
    {
        ...
        ImGui::BeginColumns("##TreeColumns", 2, ImGuiOldColumnFlags_NoBorder | ImGuiOldColumnFlags_NoResize | ImGuiOldColumnFlags_NoPreserveWidths | ImGuiOldColumnFlags_NoForceWithinWindow);
